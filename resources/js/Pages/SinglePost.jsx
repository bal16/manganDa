                    ...
                    <section className="">
                        ...
                        >
                            ...
                            <div class="relative w-full min-w-[200px]">
                                <textarea
                                    class="peer h-10 min-h-[40px] w-full resize-none border-b border-blue-gray-200 bg-transparent pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-900 focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"
                                    placeholder=" "
                                    name="body"
                                    value={data.body}
                                    required
