        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* report */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('report') && 'bg-slate-900'}`}>
                <NavLink
                  href="/db/report"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('report') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center grow">
                      <svg className="w-6 h-6 shrink-0" viewBox="0 0 24 24">
                        <path
                          className={`fill-current ${pathname.includes('report') ? 'text-indigo-500' : 'text-slate-600'}`}
                          d="M14.5 7c4.695 0 8.5 3.184 8.5 7.111 0 1.597-.638 3.067-1.7 4.253V23l-4.108-2.148a10 10 0 01-2.692.37c-4.695 0-8.5-3.184-8.5-7.11C6 10.183 9.805 7 14.5 7z"
                        />
                        <path
                          className={`fill-current ${pathname.includes('report') ? 'text-indigo-300' : 'text-slate-400'}`}
              ...
              {/* Store */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('stores') && 'bg-slate-900'}`}>
                <NavLink
                  href="/db/stores"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('stores') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center grow">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="ml-3 text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">Inbox</span>
                  </div>
                </NavLink>
              </li>
              {/* Calendar */}
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end href="/signin" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Sign in
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end href="/signup" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Sign up
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end href="/reset-password" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Reset Password
                              </span>
                            </NavLink>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end href="/onboarding-01" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 1
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end href="/onboarding-02" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 2
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end href="/onboarding-03" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 3
                              </span>
                            </NavLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end href="/onboarding-04" className="block truncate transition duration-150 text-slate-400 hover:text-slate-200">
                              <span className="text-sm font-medium duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                                Step 4
                              </span>
                            </NavLink>
